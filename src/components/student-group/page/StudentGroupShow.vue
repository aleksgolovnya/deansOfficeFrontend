      ...
      <b-row>
        ...
        <b-col class="right-section" cols="3">
          <div class="right-section-item">
            ...
            <hr>
            <h5 class="h5">Специальность</h5>
            <p class="right-section-item-link" @click="goToSpecialtyPage">
                {{ studentGroup.specialty.name }}
            </p>
            <h5 class="h5">Кафедра</h5>
            <p class="right-section-item-link" @click="goToDepartmentPage">
              {{ studentGroup.specialty.department.name }}
            </p>
            <h5 class="h5">Факультет</h5>
            <p class="right-section-item-link" @click="goToFacultyPage">
              {{ studentGroup.specialty.department.faculty.name }}
            </p>
